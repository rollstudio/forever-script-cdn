...
export const culture = () => {
  ...
  const accordion = queryElement<HTMLDivElement>(
    '[data-culture="accordion"]',
    component
  );
  const marquee = queryElement<HTMLDivElement>(
    '[data-culture="marquee"]',
    component
  );
  ...
  mm.add("(min-width: 992px)", () => {
    ...
    list.style.top = `${
      window.innerHeight - containerHeight - marqueeHeight
    }px`;
    ...
    marqueeTimeline.from(
      marquee,
      { marginTop: containerHeight, ease: "none" },
      0
    );
